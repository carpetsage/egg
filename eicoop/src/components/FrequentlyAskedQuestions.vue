    ...
    <dl class="mt-2 space-y-2">
      ...
      <div>
        ...
        <dd class="mt-1 text-gray-900 dark:text-gray-100">
          ...
          sent to you that haven't been received yet. They will most likely never reappear. Since checking coop status can interfere with your incoming tokens, it now requires manual action,
          unless you enable the "Auto-load coops" checkbox
        </dd>
      </div>
    </dl>
