      ...
      <div>
        ...
        <div class="mt-2">
          <p class="text-sm text-gray-500 dark:text-gray-400">
            Checking coop status with your EID will intercept any tokens and chicken runs you've been sent but haven't received yet.
            They will most likely never reappear.
          </p>
        </div>
