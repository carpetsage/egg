      ...
      <dl class="grid grid-cols-1 gap-x-4 gap-y-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        <div class="sm:col-span-1">
          ...
          <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">
            ...
            <a :href="'https://wasmegg-carpet.netlify.app/past-contracts/?playerId=' + status.creatorId" class="text-blue-600 hover:text-blue-700 underline" :class="'visited:text-purple-600'" >
            Past Contracts
            </a>
          </dd>
        </div>
