<template>
  <div class="space-y-4">
    ...
    <div class="flex justify-end mb-4">
      <div class="inline-flex p-1 bg-slate-100/80 rounded-xl border border-slate-200/50 shadow-inner">
        <button
          ...
          :class="timeUnit === unit.value ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-400 hover:text-slate-600'"
    ...
    <!-- Egg Value -->
    <div
      class="section-premium overflow-hidden transition-all duration-300"
      :class="{ 'shadow-lg ring-1 ring-brand-primary/10': expandedSections.eggValue }"
    >
      <div
      ...
      >
        ...
        <div class="flex items-center gap-4">
          <span class="font-mono-premium text-base font-bold text-slate-800">
            {{ formatNumber(eggValueOutput.finalValue, 3) }}
            <span class="text-[10px] text-slate-400 font-black uppercase tracking-widest ml-1">gems/egg</span>
          </span>
    ...
    <div
      class="section-premium overflow-hidden transition-all duration-300"
      :class="{ 'shadow-lg ring-1 ring-brand-primary/10': expandedSections.habCapacity }"
    >
      <div
        class="px-5 py-4 flex justify-between items-center hover:bg-slate-50/50 cursor-pointer transition-colors"
    ...
    <div
      class="section-premium overflow-hidden transition-all duration-300"
      :class="{ 'shadow-lg ring-1 ring-brand-primary/10': expandedSections.ihr }"
    >
      <div
        class="px-5 py-4 flex justify-between items-center hover:bg-slate-50/50 cursor-pointer transition-colors"
        ...
        <div class="flex items-center gap-4 text-right">
          <div class="flex flex-col">
            <span class="font-mono-premium text-sm font-bold text-slate-800">
              {{ formatNumber(ihrOutput.onlineRate, 1)
              }}<span class="text-[10px] text-slate-400 font-black ml-1 uppercase">/min online</span>
            </span>
            <span class="font-mono-premium text-sm font-bold text-slate-800">
              {{ formatNumber(ihrOutput.offlineRate, 1)
              }}<span class="text-[10px] text-slate-400 font-black ml-1 uppercase">/min offline</span>
            </span>
          </div>
    ...
    <div
      class="section-premium overflow-hidden transition-all duration-300"
      :class="{ 'shadow-lg ring-1 ring-brand-primary/10': expandedSections.layRate }"
    >
      <div
        class="px-5 py-4 flex justify-between items-center hover:bg-slate-50/50 cursor-pointer transition-colors"
      ...
      >
        ...
        <div class="flex items-center gap-4">
          <span class="font-mono-premium text-base font-bold text-slate-800">
            ...
            }}<span class="text-[10px] text-slate-400 font-black uppercase ml-1">/{{ timeUnitLabel }}</span>
          </span>
    ...
    <div
      class="section-premium overflow-hidden transition-all duration-300"
      :class="{ 'shadow-lg ring-1 ring-brand-primary/10': expandedSections.shippingCapacity }"
    >
      <div
        class="px-5 py-4 flex justify-between items-center hover:bg-slate-50/50 cursor-pointer transition-colors"
    ...
    <div
      class="section-premium overflow-hidden transition-all duration-300"
      :class="{ 'shadow-lg ring-1 ring-brand-primary/10': expandedSections.elr }"
    >
      <div
        class="px-5 py-4 flex justify-between items-center hover:bg-slate-50/50 cursor-pointer transition-colors"
    ...
    <div
      class="section-premium overflow-hidden transition-all duration-300"
      :class="{ 'shadow-lg ring-1 ring-brand-primary/10': expandedSections.earnings }"
    >
      <div
        class="px-5 py-4 flex justify-between items-center hover:bg-slate-50/50 cursor-pointer transition-colors"
      ...
      >
        ...
        <div class="flex items-center gap-4 text-right">
          <div class="flex flex-col">
            <span class="font-mono-premium text-sm font-bold text-slate-800">
              {{ formatNumber(convertedOnlineEarnings, 3)
              }}<span class="text-[10px] text-slate-400 font-black ml-1 uppercase">/{{ timeUnitLabel }} online</span>
            </span>
            <span class="font-mono-premium text-sm font-bold text-slate-800">
              {{ formatNumber(convertedOfflineEarnings, 3)
              }}<span class="text-[10px] text-slate-400 font-black ml-1 uppercase">/{{ timeUnitLabel }} offline</span>
            </span>
          </div>
    ...
    <div
      class="section-premium overflow-hidden transition-all duration-300"
      :class="{ 'shadow-lg ring-1 ring-brand-primary/10': expandedSections.siloTime }"
    >
      <div
        class="px-5 py-4 flex justify-between items-center hover:bg-slate-50/50 cursor-pointer transition-colors"
      ...
      >
        ...
        <div class="flex items-center gap-4">
          <span class="font-mono-premium text-base font-bold text-slate-800">
            {{ siloTimeOutput.formatted }}
            <span class="text-[10px] text-slate-400 font-black uppercase tracking-widest ml-1">away time</span>
          </span>
      ...
      <div v-if="expandedSections.siloTime" class="border-t border-slate-100 p-5 bg-slate-50/30">
        <div class="space-y-4 max-w-lg mx-auto">
          <div class="flex justify-between items-center p-3 bg-white rounded-xl shadow-sm border border-slate-100">
            ...
            <span class="font-mono-premium font-bold text-slate-700"
              >{{ siloTimeOutput.siloCount }} <span class="text-slate-300 font-normal">/</span>
              {{ siloTimeOutput.maxSilos }}</span
            >
          </div>
          ...
          <div class="flex justify-between items-center p-3 bg-white rounded-xl shadow-sm border border-slate-100">
            <div class="flex items-center gap-3">
              <div
                class="w-8 h-8 rounded-lg bg-slate-50 flex items-center justify-center border border-slate-100 shadow-inner"
              >
                <img
            ...
            <span class="font-mono-premium font-bold text-slate-700"
              >LVL {{ siloTimeOutput.siloCapacityLevel }} <span class="text-slate-300 font-normal">/</span> 20</span
            >
          </div>

          <div
            class="flex justify-between items-center p-3 bg-white rounded-xl shadow-sm border border-slate-100 font-bold"
          >
