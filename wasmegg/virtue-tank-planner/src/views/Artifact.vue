<template>
    <div class="mx-4 sm:mx-auto sm:max-w-xs sm:w-full mt-2 mb-4 space-y-1">
      <label for="waitTimeInput">Maximum Days to Wait</label>
      <base-input
        id="waitTimeInput"
        v-model.number="waitTime_days"
        type="number"
        name="waitTimeInput"
  ...
  <div class="-mx-4 sm:mx-0 bg-gray-50 overflow-hidden sm:rounded-lg sm:shadow-md isolate">
    ...
    <div class="px-4 py-4 sm:px-6 space-y-2">
      <ArtifactMissionOptimizer :artifact-id="artifactId" :max-wait-time_seconds="parseFloat(waitTime_days) * 86400" />
    </div>
