<template>
  ...
  >
    ...
    <a :href="`https://eicowop.netlify.app/u/${playerId}`" class="underline" target="_blank"
  ...
  <div class="mx-4 my-4 xl:mx-0 text-xs">
    ...
    <ul class="list-disc">
      ...
      <li>
        ...
        <a
          href="https://eicowop.netlify.app/"
          target="_blank"
...
export default defineComponent({
  ...
  async setup({ playerId }) {
    ...
    const contractLink = (contract: UserContract) =>
      `https://eicowop.netlify.app/?q=${encodeURIComponent(contract.id)}`;
    const coopLink = (contract: UserContract) =>
      contract.coopCode
        ? `https://eicowop.netlify.app/${encodeURIComponent(contract.id)}/${encodeURIComponent(
            contract.coopCode
          )}/`
