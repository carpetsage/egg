<template>
  <api-requester
    api-endpoint="/ei_ctx/get_contract_player_info"
    request-message="BasicRequestInfo"
    response-message="ContractPlayerInfo"
...
export default defineComponent({
  ...
  setup() {
    ...
    const getRequestPayloadObject = (): ei.IBasicRequestInfo => basicRequestInfo(userId.value);
